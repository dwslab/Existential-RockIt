// $ANTLR 3.4 com\\googlecode\\rockit\\parser\\Model.g 2014-01-22 14:19:39
...
import de.dwslab.riskmanagement.abduction.exceptions.ParseException;
import de.dwslab.riskmanagement.abduction.model.HerbrandUniverse;
import de.dwslab.riskmanagement.abduction.model.Model;
import de.dwslab.riskmanagement.abduction.model.expressions.IfExpression;
import de.dwslab.riskmanagement.abduction.model.expressions.PredicateExpression;
import de.dwslab.riskmanagement.abduction.model.formulas.FormulaCardinality;
import de.dwslab.riskmanagement.abduction.model.formulas.FormulaHard;
import de.dwslab.riskmanagement.abduction.model.formulas.FormulaSoft;
import de.dwslab.riskmanagement.abduction.model.predicates.Predicate;
import de.dwslab.riskmanagement.abduction.model.predicates.PredicateAbstract;
import de.dwslab.riskmanagement.abduction.model.predicates.PredicateDouble;
...
import de.dwslab.riskmanagement.abduction.model.variables.VariableString;
import de.dwslab.riskmanagement.abduction.model.variables.VariableType;

@SuppressWarnings({ "all", "warnings", "unchecked" })
public class ModelParser extends Parser {

    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "COMMA", "DOUBLEVAR", "FLOAT", "HASH", "ID",
        "ML_COMMENT", "NEWLINE", "NOT", "SL_COMMENT", "STAR", "STRING", "WS", "'('", "')'",
        "'.'", "':'", "'<='", "'>='", "'v'", "'|'"
    };
    ...
    // $ANTLR start "model"
    // com\\googlecode\\rockit\\parser\\Model.g:37:1: model returns [Model model = new Model()] : (
    // ( ML_COMMENT ) | ( SL_COMMENT ) | ( NEWLINE ) | (pre= predicateDefinition ) | (sf=
    // softFormulaDefinition ) | (hf= hardFormulaDefinition ) | (cf= cardinalityFormulaDefiniton )
    // )+ ;
    public final Model model() throws RecognitionException, ParseException {
        ...
        try {
            // com\\googlecode\\rockit\\parser\\Model.g:37:64: ( ( ( ML_COMMENT ) | ( SL_COMMENT ) |
            // ( NEWLINE ) | (pre= predicateDefinition ) | (sf= softFormulaDefinition ) | (hf=
            // hardFormulaDefinition ) | (cf= cardinalityFormulaDefiniton ) )+ )
            // com\\googlecode\\rockit\\parser\\Model.g:38:3: ( ( ML_COMMENT ) | ( SL_COMMENT ) | (
            // NEWLINE ) | (pre= predicateDefinition ) | (sf= softFormulaDefinition ) | (hf=
            // hardFormulaDefinition ) | (cf= cardinalityFormulaDefiniton ) )+
            {
                // com\\googlecode\\rockit\\parser\\Model.g:38:3: ( ( ML_COMMENT ) | ( SL_COMMENT )
                ...
                loop1: do {
                    ...
                    break;
                    case 7:
                        // com\\googlecode\\rockit\\parser\\Model.g:55:4: (cf=
                        // cardinalityFormulaDefiniton )
                    {
                        // com\\googlecode\\rockit\\parser\\Model.g:55:4: (cf=
                        // cardinalityFormulaDefiniton )
                        // com\\googlecode\\rockit\\parser\\Model.g:55:5: cf=
                        // cardinalityFormulaDefiniton
                        {
    ...
    // com\\googlecode\\rockit\\parser\\Model.g:70:1: softFormulaDefinition returns [FormulaSoft
    // formula] : ( (f= FLOAT ) | (dv= ID ':' ) ) formulaHard= formulaBodyDefinition ;
    public final FormulaSoft softFormulaDefinition() throws RecognitionException, ParseException {
        ...
        try {
            // com\\googlecode\\rockit\\parser\\Model.g:70:74: ( ( (f= FLOAT ) | (dv= ID ':' ) )
            // formulaHard= formulaBodyDefinition )
            // com\\googlecode\\rockit\\parser\\Model.g:71:5: ( (f= FLOAT ) | (dv= ID ':' ) )
            // formulaHard= formulaBodyDefinition
            {
                ...
                if (doubleVariable != null) {
                    formula.setDoubleVariable(doubleVariable);
                }
                ...
                if (formulaHard.isConjunction()) {
                    formula.setConjunction();
                }
                if (formulaHard.isDisjunction()) {
                    formula.setDisjunction();
                }
    ...
    // com\\googlecode\\rockit\\parser\\Model.g:105:1: hardFormulaDefinition returns [FormulaHard
    // formula] : formulaHard= formulaBodyDefinition '.' ;
    ...
    // com\\googlecode\\rockit\\parser\\Model.g:119:1: cardinalityFormulaDefiniton returns
    // [FormulaCardinality formula] : ( '|' (var1= ID ) ( ',' (var2= ID ) )* '|' ) hardFormula=
    // formulaBodyDefinition (operator= ( '<=' | '>=' ) ) (cardinality= FLOAT ) ;
    public final FormulaCardinality cardinalityFormulaDefiniton() throws RecognitionException,
    ParseException {
        ...
        try {
            // com\\googlecode\\rockit\\parser\\Model.g:119:87: ( ( '|' (var1= ID ) ( ',' (var2= ID
            // ) )* '|' ) hardFormula= formulaBodyDefinition (operator= ( '<=' | '>=' ) )
            // (cardinality= FLOAT ) )
            // com\\googlecode\\rockit\\parser\\Model.g:121:5: ( '|' (var1= ID ) ( ',' (var2= ID )
            // )* '|' ) hardFormula= formulaBodyDefinition (operator= ( '<=' | '>=' ) )
            // (cardinality= FLOAT )
            {
                ...
                // )* '|'
                {
                    ...
                    loop3: do {
                            ...
                            // com\\googlecode\\rockit\\parser\\Model.g:129:6: ',' (var2= ID )
                        {
                            ...
                            {
                                var2 = (Token) match(input, ID,
                                        FOLLOW_ID_in_cardinalityFormulaDefiniton303);
                ...
                // if we have a cardinality formula, we need to figure out if the preliminary over
                // variables
                ...
                for (VariableType search : preliminaryOverVariables) {
                    ...
                    if (!found) {
                        throw new ParseException(
                                "Over-variable "
                                        + search
                                        + " could not be found in the formula body of the following formula: "
                                        + formula.toString()
                                        + " Every over variable has to occur in the formula body.");
                    }
                }
                ...
                {
                    cardinality = (Token) match(input, FLOAT,
                            FOLLOW_FLOAT_in_cardinalityFormulaDefiniton353);
                ...
                formula = new FormulaCardinality(hardFormula.getName(),
                        hardFormula.getForVariables(), hardFormula.getIfExpressions(),
    ...
    // com\\googlecode\\rockit\\parser\\Model.g:171:1: formulaBodyDefinition returns [FormulaHard
    // formula] : e1= expressionDefinition ( 'v' e2= expressionDefinition )* ;
    public final FormulaHard formulaBodyDefinition() throws RecognitionException, ParseException {
        ...
        try {
            // com\\googlecode\\rockit\\parser\\Model.g:171:74: (e1= expressionDefinition ( 'v' e2=
            // expressionDefinition )* )
            // com\\googlecode\\rockit\\parser\\Model.g:172:5: e1= expressionDefinition ( 'v' e2=
            // expressionDefinition )*
            {
    ...
    // com\\googlecode\\rockit\\parser\\Model.g:219:1: expressionDefinition returns
    // [ArrayList<IfExpression> expressions = new ArrayList<IfExpression>();] : (n0= NOT )? predId=
    // ID '(' ( (var1= ID ) | ( (n1= NOT )? (string1= STRING ) ) ) ( ',' ( (var2= ID ) | ( (n2= NOT
    // )? (string2= STRING ) ) ) )* ')' ;
    public final ArrayList<IfExpression> expressionDefinition() throws RecognitionException,
    ParseException {
        ...
        try {
            // com\\googlecode\\rockit\\parser\\Model.g:219:122: ( (n0= NOT )? predId= ID '(' (
            // (var1= ID ) | ( (n1= NOT )? (string1= STRING ) ) ) ( ',' ( (var2= ID ) | ( (n2= NOT
            // )? (string2= STRING ) ) ) )* ')' )
            // com\\googlecode\\rockit\\parser\\Model.g:220:6: (n0= NOT )? predId= ID '(' ( (var1=
            // ID ) | ( (n1= NOT )? (string1= STRING ) ) ) ( ',' ( (var2= ID ) | ( (n2= NOT )?
            // (string2= STRING ) ) ) )* ')'
            {
                ...
                if (!predicates.contains(search)) {
                    throw new ParseException("Predicate "
                            + predId.getText() + " at line " + predId.getLine() + " and position "
                            + predId.getCharPositionInLine()
                            + " has not been defined. Check for typos (case sensitive).");
                } else {
                ...
                // com\\googlecode\\rockit\\parser\\Model.g:237:10: ( (var1= ID ) | ( (n1= NOT )?
                // (string1= STRING ) ) )
                int alt7 = 2;
                switch (input.LA(1)) {
                case ID: {
                ...
                case 2:
                    ...
                    // )
                {
                    // com\\googlecode\\rockit\\parser\\Model.g:237:21: ( (n1= NOT )? (string1=
                    // STRING ) )
                    ...
                    // )
                    {
                        ...
                        {
                            string1 = (Token) match(input, STRING,
                                    FOLLOW_STRING_in_expressionDefinition483);
                ...
                // com\\googlecode\\rockit\\parser\\Model.g:249:6: ( ',' ( (var2= ID ) | ( (n2= NOT
                // )? (string2= STRING ) ) ) )*
                loop10: do {
                    int alt10 = 2;
                    switch (input.LA(1)) {
                    ...
                    switch (alt10) {
                    case 1:
                        // com\\googlecode\\rockit\\parser\\Model.g:249:7: ',' ( (var2= ID ) | ( (n2=
                        // NOT )? (string2= STRING ) ) )
                    {
                        match(input, COMMA, FOLLOW_COMMA_in_expressionDefinition496);

                        // com\\googlecode\\rockit\\parser\\Model.g:249:11: ( (var2= ID ) | ( (n2=
                        // NOT )? (string2= STRING ) ) )
                        int alt9 = 2;
                        switch (input.LA(1)) {
                        case ID: {
                            ...
                            // com\\googlecode\\rockit\\parser\\Model.g:249:12: (var2= ID )
                        {
                            ...
                            {
                                var2 = (Token) match(input, ID,
                                        FOLLOW_ID_in_expressionDefinition502);
                        ...
                        break;
                        case 2:
                            // com\\googlecode\\rockit\\parser\\Model.g:249:22: ( (n2= NOT )? (string2=
                            // STRING ) )
                        {
                            // com\\googlecode\\rockit\\parser\\Model.g:249:22: ( (n2= NOT )?
                            // (string2= STRING ) )
                            ...
                            // (string2= STRING )
                            {
                                ...
                                {
                                    n2 = (Token) match(input, NOT,
                                            FOLLOW_NOT_in_expressionDefinition509);
                                ...
                                {
                                    string2 = (Token) match(input, STRING,
                                            FOLLOW_STRING_in_expressionDefinition515);
                    ...
                    if (ifExpression instanceof PredicateExpression) {
                        ...
                        if (p instanceof Predicate && !(types.size() == variables.size())) {
                            throw new ParseException(
                                    "Predicate "
                                            + p
                                            + " has not the same size in types and variables in the current equation. Types are: "
                                            + types.toString() + ". Variables are: "
                                            + variables.toString());
                        } else if (p instanceof PredicateDouble
                                && !(types.size() + 1 == variables.size())) {
                            throw new ParseException(
                                    "Double Predicate "
                                            + p
                                            + " has not the same size in types and variables in the current equation. Types are: "
                                            + types.toString() + ", Double]. Variables are: "
                                            + variables.toString());
                        }
                        // set last variable of PredicateDouble to DoubleVariable. Before we have no
                        // chance to detect if this is the last variable.
                        if (p instanceof PredicateDouble) {
                            VariableAbstract transformToDoubleVar = variables
                                    .get(variables.size() - 1);
                            VariableDouble transformed = new VariableDouble(
                                    transformToDoubleVar.getName());
                            variables.set(variables.size() - 1, transformed);
                            expression.setVariables(variables);
                        }
                        // set variable types (in case of the double variable, the last variable is
                        // not tuched.
                        for (int i = 0; i < types.size(); i++) {
                            ...
                            if (varAbstract instanceof VariableType) {
                                ...
                                throw new ParseException("No double Type allowed " + type
                                        + ". Variable must not be a double var. " + varAbstract);
                            }
                        }
                    }
                }
    ...
    // com\\googlecode\\rockit\\parser\\Model.g:301:1: predicateDefinition returns
    // [PredicateAbstract predicate] : ( STAR )? id1= ID '(' t1= typeDefinition ( ',' t2=
    // typeDefinition )* ( ',' d= DOUBLEVAR (id2= ID )? )? ')' ;
    public final PredicateAbstract predicateDefinition() throws RecognitionException,
    ParseException {
        PredicateAbstract predicate = null;
        ...
        try {
            // com\\googlecode\\rockit\\parser\\Model.g:301:80: ( ( STAR )? id1= ID '(' t1=
            // typeDefinition ( ',' t2= typeDefinition )* ( ',' d= DOUBLEVAR (id2= ID )? )? ')' )
            // com\\googlecode\\rockit\\parser\\Model.g:302:9: ( STAR )? id1= ID '(' t1=
            // typeDefinition ( ',' t2= typeDefinition )* ( ',' d= DOUBLEVAR (id2= ID )? )? ')'
            {
                ...
                if (d == null) {
                    ...
                    if (isHidden) {
                        throw new ParseException(
                                "Double predicates are not allowed to be hidden. Predicate "
                                        + id1.getText() + " at line " + id1.getLine()
                                        + " and position " + id1.getCharPositionInLine()
                                        + " violates that rule.");
                    }
                ...
                if (predicates.contains(predicate)) {
                    throw new ParseException("Predicate "
                            + id1.getText() + " at line " + id1.getLine() + " and position "
                            + id1.getCharPositionInLine()
                            + " had already been created. The new predicate is ignored");
                } else {
    ...
    public static final BitSet FOLLOW_ML_COMMENT_in_model53 = new BitSet(
            new long[] { 0x0000000000803F42L });
    public static final BitSet FOLLOW_SL_COMMENT_in_model59 = new BitSet(
            new long[] { 0x0000000000803F42L });
    public static final BitSet FOLLOW_NEWLINE_in_model65 = new BitSet(
            new long[] { 0x0000000000803F42L });
    public static final BitSet FOLLOW_predicateDefinition_in_model76 = new BitSet(
            new long[] { 0x0000000000803F42L });
    public static final BitSet FOLLOW_softFormulaDefinition_in_model88 = new BitSet(
            new long[] { 0x0000000000803F42L });
    public static final BitSet FOLLOW_hardFormulaDefinition_in_model100 = new BitSet(
            new long[] { 0x0000000000803F42L });
    public static final BitSet FOLLOW_cardinalityFormulaDefiniton_in_model112 = new BitSet(
            new long[] { 0x0000000000803F42L });
    public static final BitSet FOLLOW_FLOAT_in_softFormulaDefinition164 = new BitSet(
            new long[] { 0x0000000000000900L });
    public static final BitSet FOLLOW_ID_in_softFormulaDefinition177 = new BitSet(
            new long[] { 0x0000000000080000L });
    public static final BitSet FOLLOW_19_in_softFormulaDefinition179 = new BitSet(
            new long[] { 0x0000000000000900L });
    public static final BitSet FOLLOW_formulaBodyDefinition_in_softFormulaDefinition191 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_formulaBodyDefinition_in_hardFormulaDefinition230 = new BitSet(
            new long[] { 0x0000000000040000L });
    public static final BitSet FOLLOW_18_in_hardFormulaDefinition242 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_23_in_cardinalityFormulaDefiniton284 = new BitSet(
            new long[] { 0x0000000000000100L });
    public static final BitSet FOLLOW_ID_in_cardinalityFormulaDefiniton289 = new BitSet(
            new long[] { 0x0000000000800010L });
    public static final BitSet FOLLOW_COMMA_in_cardinalityFormulaDefiniton298 = new BitSet(
            new long[] { 0x0000000000000100L });
    public static final BitSet FOLLOW_ID_in_cardinalityFormulaDefiniton303 = new BitSet(
            new long[] { 0x0000000000800010L });
    public static final BitSet FOLLOW_23_in_cardinalityFormulaDefiniton314 = new BitSet(
            new long[] { 0x0000000000000900L });
    public static final BitSet FOLLOW_formulaBodyDefinition_in_cardinalityFormulaDefiniton323 = new BitSet(
            new long[] { 0x0000000000300000L });
    public static final BitSet FOLLOW_set_in_cardinalityFormulaDefiniton343 = new BitSet(
            new long[] { 0x0000000000000040L });
    public static final BitSet FOLLOW_FLOAT_in_cardinalityFormulaDefiniton353 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_expressionDefinition_in_formulaBodyDefinition388 = new BitSet(
            new long[] { 0x0000000000400002L });
    public static final BitSet FOLLOW_22_in_formulaBodyDefinition397 = new BitSet(
            new long[] { 0x0000000000000900L });
    public static final BitSet FOLLOW_expressionDefinition_in_formulaBodyDefinition401 = new BitSet(
            new long[] { 0x0000000000400002L });
    public static final BitSet FOLLOW_NOT_in_expressionDefinition449 = new BitSet(
            new long[] { 0x0000000000000100L });
    public static final BitSet FOLLOW_ID_in_expressionDefinition455 = new BitSet(
            new long[] { 0x0000000000010000L });
    public static final BitSet FOLLOW_16_in_expressionDefinition464 = new BitSet(
            new long[] { 0x0000000000004900L });
    public static final BitSet FOLLOW_ID_in_expressionDefinition470 = new BitSet(
            new long[] { 0x0000000000020010L });
    public static final BitSet FOLLOW_NOT_in_expressionDefinition477 = new BitSet(
            new long[] { 0x0000000000004000L });
    public static final BitSet FOLLOW_STRING_in_expressionDefinition483 = new BitSet(
            new long[] { 0x0000000000020010L });
    public static final BitSet FOLLOW_COMMA_in_expressionDefinition496 = new BitSet(
            new long[] { 0x0000000000004900L });
    public static final BitSet FOLLOW_ID_in_expressionDefinition502 = new BitSet(
            new long[] { 0x0000000000020010L });
    public static final BitSet FOLLOW_NOT_in_expressionDefinition509 = new BitSet(
            new long[] { 0x0000000000004000L });
    public static final BitSet FOLLOW_STRING_in_expressionDefinition515 = new BitSet(
            new long[] { 0x0000000000020010L });
    public static final BitSet FOLLOW_17_in_expressionDefinition536 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_STAR_in_predicateDefinition566 = new BitSet(
            new long[] { 0x0000000000000100L });
    public static final BitSet FOLLOW_ID_in_predicateDefinition572 = new BitSet(
            new long[] { 0x0000000000010000L });
    public static final BitSet FOLLOW_16_in_predicateDefinition584 = new BitSet(
            new long[] { 0x0000000000000100L });
    public static final BitSet FOLLOW_typeDefinition_in_predicateDefinition588 = new BitSet(
            new long[] { 0x0000000000020010L });
    public static final BitSet FOLLOW_COMMA_in_predicateDefinition601 = new BitSet(
            new long[] { 0x0000000000000100L });
    public static final BitSet FOLLOW_typeDefinition_in_predicateDefinition605 = new BitSet(
            new long[] { 0x0000000000020010L });
    public static final BitSet FOLLOW_COMMA_in_predicateDefinition622 = new BitSet(
            new long[] { 0x0000000000000020L });
    public static final BitSet FOLLOW_DOUBLEVAR_in_predicateDefinition626 = new BitSet(
            new long[] { 0x0000000000020100L });
    public static final BitSet FOLLOW_ID_in_predicateDefinition631 = new BitSet(
            new long[] { 0x0000000000020000L });
    public static final BitSet FOLLOW_17_in_predicateDefinition655 = new BitSet(
            new long[] { 0x0000000000000002L });
    public static final BitSet FOLLOW_ID_in_typeDefinition679 = new BitSet(
            new long[] { 0x0000000000000002L });
