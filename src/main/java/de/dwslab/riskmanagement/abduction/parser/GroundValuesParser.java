// $ANTLR 3.4 com\\googlecode\\rockit\\parser\\GroundValues.g 2013-06-12 11:46:07
...
public class GroundValuesParser extends Parser {
    ...
    public static final String[] tokenNames = new String[] {
            "<invalid>", "<EOR>", "<DOWN>", "<UP>", "FLOAT", "ID", "ML_COMMENT", "NEWLINE", "NOT",
            "SL_COMMENT", "STRING", "WS", "'('", "')'", "','"
    };
    ...
    public String[] getTokenNames() {
        return GroundValuesParser.tokenNames;
    }
    ...
    // com\\googlecode\\rockit\\parser\\GroundValues.g:24:1: groundValues returns
    // [TreeSet<PredicateAbstract> predicates] : ( ( ML_COMMENT ) | ( SL_COMMENT ) | ( NEWLINE ) | (
    // predicateDefinition ) )* ;
    public final TreeSet<PredicateAbstract> groundValues() throws RecognitionException,
            ParseException {
        TreeSet<PredicateAbstract> predicates = null;

        try {
            // com\\googlecode\\rockit\\parser\\GroundValues.g:24:83: ( ( ( ML_COMMENT ) | (
            // SL_COMMENT ) | ( NEWLINE ) | ( predicateDefinition ) )* )
            // com\\googlecode\\rockit\\parser\\GroundValues.g:25:3: ( ( ML_COMMENT ) | ( SL_COMMENT
            // ) | ( NEWLINE ) | ( predicateDefinition ) )*
            {
                // com\\googlecode\\rockit\\parser\\GroundValues.g:25:3: ( ( ML_COMMENT ) | (
                // SL_COMMENT ) | ( NEWLINE ) | ( predicateDefinition ) )*
                loop1: do {
                    int alt1 = 5;
                    switch (input.LA(1)) {
                    ...
                    {
                        // com\\googlecode\\rockit\\parser\\GroundValues.g:27:4: (
                        // predicateDefinition )
    ...
    // com\\googlecode\\rockit\\parser\\GroundValues.g:33:1: predicateDefinition : ( (n= NOT )? )
    // pid= ID '(' (t1= ID |s1= STRING ) ( ',' (t2= ID |s1= STRING ) )* ( ',' f= FLOAT )? ')' ;
    public final void predicateDefinition() throws RecognitionException, ParseException {
        ...
        try {
            // com\\googlecode\\rockit\\parser\\GroundValues.g:33:42: ( ( (n= NOT )? ) pid= ID '('
            // (t1= ID |s1= STRING ) ( ',' (t2= ID |s1= STRING ) )* ( ',' f= FLOAT )? ')' )
            // com\\googlecode\\rockit\\parser\\GroundValues.g:34:8: ( (n= NOT )? ) pid= ID '(' (t1=
            // ID |s1= STRING ) ( ',' (t2= ID |s1= STRING ) )* ( ',' f= FLOAT )? ')'
            {
                ...
                loop5: do {
                    ...
                    switch (alt5) {
                    case 1:
                    // com\\googlecode\\rockit\\parser\\GroundValues.g:44:10: ',' (t2= ID |s1=
                    // STRING )
                    {
                        match(input, 14, FOLLOW_14_in_predicateDefinition164);

                        // com\\googlecode\\rockit\\parser\\GroundValues.g:44:14: (t2= ID |s1=
                        // STRING )
                        int alt4 = 2;
                        switch (input.LA(1)) {
                        case ID: {
                        ...
                        {
                            s1 = (Token) match(input, STRING,
                                    FOLLOW_STRING_in_predicateDefinition175);
    ...
    public static final BitSet FOLLOW_ML_COMMENT_in_groundValues51 = new BitSet(
            new long[] { 0x00000000000003E2L });
    public static final BitSet FOLLOW_SL_COMMENT_in_groundValues57 = new BitSet(
            new long[] { 0x00000000000003E2L });
    public static final BitSet FOLLOW_NEWLINE_in_groundValues63 = new BitSet(
            new long[] { 0x00000000000003E2L });
    public static final BitSet FOLLOW_predicateDefinition_in_groundValues72 = new BitSet(
            new long[] { 0x00000000000003E2L });
    public static final BitSet FOLLOW_NOT_in_predicateDefinition121 = new BitSet(
            new long[] { 0x0000000000000020L });
    public static final BitSet FOLLOW_ID_in_predicateDefinition127 = new BitSet(
            new long[] { 0x0000000000001000L });
    public static final BitSet FOLLOW_12_in_predicateDefinition139 = new BitSet(
            new long[] { 0x0000000000000420L });
    public static final BitSet FOLLOW_ID_in_predicateDefinition144 = new BitSet(
            new long[] { 0x0000000000006000L });
    public static final BitSet FOLLOW_STRING_in_predicateDefinition150 = new BitSet(
            new long[] { 0x0000000000006000L });
    public static final BitSet FOLLOW_14_in_predicateDefinition164 = new BitSet(
            new long[] { 0x0000000000000420L });
    public static final BitSet FOLLOW_ID_in_predicateDefinition169 = new BitSet(
            new long[] { 0x0000000000006000L });
    public static final BitSet FOLLOW_STRING_in_predicateDefinition175 = new BitSet(
            new long[] { 0x0000000000006000L });
    public static final BitSet FOLLOW_14_in_predicateDefinition193 = new BitSet(
            new long[] { 0x0000000000000010L });
    public static final BitSet FOLLOW_FLOAT_in_predicateDefinition197 = new BitSet(
            new long[] { 0x0000000000002000L });
    public static final BitSet FOLLOW_13_in_predicateDefinition210 = new BitSet(
