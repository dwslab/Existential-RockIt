package de.dwslab.riskmanagement.abduction.existential;
...
public class Formula
{
    ...
    public List<String> getGroundFormulas(Map<String, Predicate> predicates, Map<String, String> predMapping, Map<String, List<String>> entities, Map<String, Set<Literal>> groundings)
    {
        List<String> groundFormulas = new ArrayList<>();

        List<Map<String, String>> combintations = generateVariableGroundings(getVariables(predicates), entities);
    ...
    private List<Map<String, String>> generateVariableGroundings(Map<String, String> variables, Map<String, List<String>> entities)
    {
