...
public class FormulaSoft extends FormulaHard {
    ...
    public FormulaSoft(String name, HashSet<VariableType> forVariables,
            ArrayList<IfExpression> ifExpressions,
            VariableDouble doubleVariable, ArrayList<PredicateExpression> restrictions,
            boolean usesConjunction) throws ParseException {
