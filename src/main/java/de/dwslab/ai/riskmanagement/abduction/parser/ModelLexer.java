...
public class ModelLexer extends Lexer {
    ...
    public final void mID() throws RecognitionException {
        try {
            int _type = ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\rockit\\parser\\Model.g:345:5: ( ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a'
            // .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )* )
            // com\\googlecode\\rockit\\parser\\Model.g:345:9: ( 'a' .. 'z' | 'A' .. 'Z' ) ( 'a' ..
            // 'z' | 'A' .. 'Z' | '0' .. '9' | '_' )*
            {
                ...
                // com\\googlecode\\rockit\\parser\\Model.g:345:28: ( 'a' .. 'z' | 'A' .. 'Z' | '0'
                // .. '9' | '_' )*
                loop1: do {
                    int alt1 = 2;
                    switch (input.LA(1)) {
    ...
    public final void mFLOAT() throws RecognitionException {
        try {
            int _type = FLOAT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\rockit\\parser\\Model.g:355:3: ( ( '+' | '-' )? ( '0' .. '9' )+ (
            // '.' ( '0' .. '9' )* )? )
            // com\\googlecode\\rockit\\parser\\Model.g:355:5: ( '+' | '-' )? ( '0' .. '9' )+ ( '.'
            // ( '0' .. '9' )* )?
            {
    ...
    public void mTokens() throws RecognitionException {
        // com\\googlecode\\rockit\\parser\\Model.g:1:8: ( T__16 | T__17 | T__18 | T__19 | T__20 |
        // T__21 | T__22 | T__23 | DOUBLEVAR | ID | STRING | NEWLINE | WS | STAR | HASH | COMMA |
        // NOT | FLOAT | ML_COMMENT | SL_COMMENT )
        int alt10 = 20;
        switch (input.LA(1)) {
        case '(': {
            alt10 = 1;
