...
public class HerbrandUniverse {
    ...
    public String transformKeysToConstants(String compromizedAxiom) {
        ...
        output.append("\"").append(this.getConstant(resArray[resArray.length - 1])).append("\"")
                .append(")");
        return output.toString();
    }

    /**
     * Returns the maximal key size s of all current strings. This is used as length in the sql
     * tables (char(s)).
     * 
     * @return
     */
