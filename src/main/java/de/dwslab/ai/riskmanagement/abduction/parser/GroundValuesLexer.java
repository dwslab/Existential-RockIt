...
public class GroundValuesLexer extends Lexer {
    ...
    public final void mID() throws RecognitionException {
        try {
            int _type = ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\rockit\\parser\\GroundValues.g:71:5: ( ( 'a' .. 'z' | 'A' .. 'Z' ) (
            // 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )* )
            // com\\googlecode\\rockit\\parser\\GroundValues.g:71:9: ( 'a' .. 'z' | 'A' .. 'Z' ) (
            // 'a' .. 'z' | 'A' .. 'Z' | '0' .. '9' | '_' | '-' )*
            {
                ...
                // com\\googlecode\\rockit\\parser\\GroundValues.g:71:28: ( 'a' .. 'z' | 'A' .. 'Z'
                // | '0' .. '9' | '_' | '-' )*
                loop1: do {
                    int alt1 = 2;
                    switch (input.LA(1)) {
    ...
    public final void mFLOAT() throws RecognitionException {
        try {
            int _type = FLOAT;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // com\\googlecode\\rockit\\parser\\GroundValues.g:77:3: ( ( '+' | '-' )? ( '0' .. '9'
            // )+ ( '.' ( '0' .. '9' )* )? )
            // com\\googlecode\\rockit\\parser\\GroundValues.g:77:5: ( '+' | '-' )? ( '0' .. '9' )+
            // ( '.' ( '0' .. '9' )* )?
            {
    ...
    public void mTokens() throws RecognitionException {
        // com\\googlecode\\rockit\\parser\\GroundValues.g:1:8: ( T__12 | T__13 | T__14 | ID |
        // STRING | NOT | NEWLINE | WS | FLOAT | ML_COMMENT | SL_COMMENT )
        int alt10 = 11;
        switch (input.LA(1)) {
        case '(': {
            alt10 = 1;
