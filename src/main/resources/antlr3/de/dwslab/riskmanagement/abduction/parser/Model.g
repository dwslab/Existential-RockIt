...
import de.dwslab.riskmanagement.abduction.model.*;
import de.dwslab.riskmanagement.abduction.model.predicates.*;
import de.dwslab.riskmanagement.abduction.model.types.*;
import de.dwslab.riskmanagement.abduction.model.formulas.*;
import de.dwslab.riskmanagement.abduction.model.formulas.expressions.*;
import de.dwslab.riskmanagement.abduction.model.formulas.expressions.impl.*;
import de.dwslab.riskmanagement.abduction.model.formulas.variables.impl.*;
import de.dwslab.riskmanagement.abduction.model.HerbrandUniverse;
import de.dwslab.riskmanagement.abduction.exception.ParseException;
}
@lexer::header{ 
package de.dwslab.riskmanagement.abduction.parser; 
} 
